...
CREATE TABLE IF NOT EXISTS usuarios (
    ...
    recovery_code_usado     INTEGER NOT NULL DEFAULT 0,   -- 0 = no usado, 1 = usado
...
CREATE TABLE IF NOT EXISTS configuracion (
    ...
    tema                TEXT NOT NULL DEFAULT 'claro',    -- claro | oscuro
...
CREATE TABLE IF NOT EXISTS inventario_movimientos (
    ...
    cantidad            REAL NOT NULL,
    referencia_tipo     TEXT,              -- venta | compra | ajuste | anulacion | devolucion
...
CREATE TABLE IF NOT EXISTS caja_movimientos (
    ...
    tipo                TEXT NOT NULL,     -- venta | ingreso_manual | egreso | retiro | compra
    monto               REAL NOT NULL,
    descripcion         TEXT,
    referencia_id       INTEGER,           -- ej. venta_id o compra_id
    fecha               TEXT NOT NULL DEFAULT (datetime('now', 'localtime'))
);
...
CREATE TABLE IF NOT EXISTS configuracion_impresion (
    id                  INTEGER PRIMARY KEY CHECK (id = 1),
    tipo_impresora      TEXT DEFAULT 'termica_58mm',   -- termica_58mm | termica_80mm | ninguna
